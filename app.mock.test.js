...
describe('POST /users - Valid User Registration (MOCKED)', () => {
    afterEach(() => {
        jest.clearAllMocks()
    })
...
describe('POST /users - Invalid Username (MOCKED)', () => {
    afterEach(() => {
        jest.clearAllMocks()
    })
...
describe('POST /users - Invalid Password (MOCKED)', () => {
    afterEach(() => {
        jest.clearAllMocks()
    })
...
describe('POST /users - Invalid Email (MOCKED)', () => {
    afterEach(() => {
        jest.clearAllMocks()
    })
...
describe('POST /users - Multiple Invalid Fields (MOCKED)', () => {
    afterEach(() => {
        jest.clearAllMocks()
    })
...
describe('POST /users - Edge Cases (MOCKED)', () => {
    afterEach(() => {
        jest.clearAllMocks()
    })
